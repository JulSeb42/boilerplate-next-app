...
export const COMMON_TEXTS = {
	...
	EMAIL_RESET_PASSWORD_BODY: (user: User, token: string) =>
		`Hello ${user.fullName},<br /><br />To reset your password, <a href="${process.env.ORIGIN}/reset-password?token=${token}&id=${user._id}">click here</a>.`,
	...
	ERRORS: {
		...
		WRONG_PASSWORD: "This password is not valid.",
